...
public class BankLookupServiceImp implements BankLookupService { //implements SiteLookupService
        ...
        if (!(cTrade == null || cTrade.contains("Error\":"))  ) {
            ...
            switch (nId_Bank) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    oTrade = json2Trade03Converter.convert(cTrade);
    ...
    private String getExchangeRate(String urlOverHttps) {
        //System.out.println("Govbank");
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<String> rateResponse =
                restTemplate.exchange(urlOverHttps,
