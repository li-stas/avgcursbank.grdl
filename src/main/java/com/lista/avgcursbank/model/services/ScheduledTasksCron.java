...
public class ScheduledTasksCron {
    ...
    private final AO_tradeRepository tradeRepository;
    private final TradeFindByDateTradeIdBank tradeFindByDateTradeIdBank;

    public ScheduledTasksCron(SpringBootConfiguration config,
                              LookUpBankCurs lookUpBankCurs,
                              AO_tradeRepository tradeRepository, TradeFindByDateTradeIdBank tradeFindByDateTradeIdBank) {
        this.config = config;
        this.lookUpBankCurs = lookUpBankCurs;
        this.tradeRepository = tradeRepository;
        this.tradeFindByDateTradeIdBank = tradeFindByDateTradeIdBank;
    }
